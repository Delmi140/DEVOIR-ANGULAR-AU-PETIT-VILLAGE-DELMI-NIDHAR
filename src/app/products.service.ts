...
export class ProductsService {
  ...
  products = [
    {id:1 , name: "Figurine Astérix ", description: 'À propos de cet article :' , price: 12.99 , size : 'Hauteur:23,5 cm ',weight : 'Poids: 300g', matter:'Matière :Résine', madein:'Fabriqué en :France',year:'Année : 2021',imageUrl :'../assets/image/figurine Astérix .jpg',descriptionCard:'Retrouvez ici Obélix, de la célèbre série Astérix et Obélix par Uderzo et Goscinny.Format : 9 x 19 X 12 cm, fabriquée en résine.'},
